...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests()
                ...
                .antMatchers("/shoutbox").permitAll()
                .antMatchers("/resources").permitAll()
                .antMatchers("/hideMain").authenticated()
                .antMatchers("/deleteMain").authenticated()
                .antMatchers("/hideMine").authenticated()
                .antMatchers("/deleteMine").authenticated()
                .antMatchers("/unhideMine").authenticated()
                .antMatchers("/download").permitAll()
                .antMatchers("/toggle_account").fullyAuthenticated()
                .antMatchers("/delete_all").fullyAuthenticated()
